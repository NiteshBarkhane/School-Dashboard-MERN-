...
export async function updatedmin(adminData) {
  const response = await axios.put(`${backend_url}/api/v1/admin/update`, adminData);
  if (response) return response.data;
}
...
export async function registerStudent(studentData) {
  const response = await axios.post(`${backend_url}/api/v1/student/register`, studentData);
  if (response) return response.data;
}

// get single student
export async function getStudent(studentId) {
  const response = await axios.get(`${backend_url}/api/v1/student/single/${studentId}`);
  if (response) return response.data;
}
...
export async function deleteStudent(studentId) {
  const response = await axios.delete(`${backend_url}/api/v1/student/delete/${studentId}`);
  if (response) return response.data;
}
...
export async function registerTeacher(teacherData) {
  const response = await axios.post(`${backend_url}/api/v1/teacher/register`, teacherData);
  if (response) return response.data;
}

// get single teacher
export async function getTeacher(teacherId) {
  const response = await axios.get(`${backend_url}/api/v1/teacher/single/${teacherId}`);
  if (response) return response.data;
}
...
export async function deleteTeacher(teacherId) {
  const response = await axios.delete(`${backend_url}/api/v1/teacher/delete/${teacherId}`);
  if (response) return response.data;
}
...
export async function createClass(classData) {
  const response = await axios.post(`${backend_url}/api/v1/class/create`, classData);
  if (response) return response.data;
}

// get single class
export async function getClass(classId) {
  const response = await axios.get(`${backend_url}/api/v1/class/single/${classId}`);
  if (response) return response.data;
}
...
export async function deleteClass(classId) {
  const response = await axios.delete(`${backend_url}/api/v1/class/delete/${classId}`);
  if (response) return response.data;
}
...
export async function createSchedule(scheduleData) {
  const response = await axios.post(`${backend_url}/api/v1/schedule/create`, scheduleData);
  if (response) return response.data;
}

// get single schedule
export async function getSchedule(scheduleId) {
  const response = await axios.get(`${backend_url}/api/v1/schedule/single/${scheduleId}`);
  if (response) return response.data;
}
...
export async function deleteSchedule(scheduleId) {
  const response = await axios.delete(`${backend_url}/api/v1/schedule/delete/${scheduleId}`);
  if (response) return response.data;
}
