...
import { Loading } from "../";
import { getStudent } from "../../api/apis";
...
const StudentViewModal = () => {
  ...
  function closeModal() {
    navigate(`/${loggedUser.role}/student/all`);
  }
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-10 flex items-start justify-center bg-black bg-opacity-50 backdrop-blur-sm">
        <div
          ref={modalboxRef}
