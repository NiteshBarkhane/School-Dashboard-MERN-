  ...
  return (
    <>
      ...
      <div className="w-full">
        {/* Header */}
        <MyHeader title="Add teacher form" icon="LiaChalkboardTeacherSolid" />
              ...
              <div className="w-full flex justify-start gap-4 items-center">
                ...
                {departments.length > 0 &&
                  departments.map((dept, index) => (
                    <span key={index}>
                      <label htmlFor={index}>{dept}</label>
                      <input
                        type="checkbox"
                        id={index}
                        name="department"
                        value={dept}
                        checked={selectedDepartment.includes(index)}
                        onChange={() => handleDepartment(index)}
                      />
                    </span>
                  ))}
              </div>
